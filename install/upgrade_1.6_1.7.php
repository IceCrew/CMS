...
if(empty($_GET)) {
?>
<a href="upgrade_1.6_1.7.php?step=1">Mit dem Upgrade von <? echo $version." auf ".$cmsversion ?> beginnen</a>
</form>
<?
}
if(isset($_GET['step'])) {
if($_GET['step'] == 1) {
?>
<form action="upgrade_1.6_1.7.php?step=2" method="post">
...
if (is_writable($configfile)) {
    ...
    fclose($handle);
	echo "<br><a href='upgrade_1.6_1.7.php?success'>Weiter</a>";
	echo '<meta http-equiv="refresh" content="0; url=upgrade_1.6_1.7.php?success">';
...
?>
<form action="upgrade_1.6_1.7.php?success" method="post">
