<center>
<?php
echo '<img src="images/site/logo.png" onmouseover="this.src=\'images/site/logo_hover.png\';" onmouseout="this.src=\'images/site/logo.png\';"></img><br><body background="images/site/background.png"></body>';
